...
public class LoaderFromResourcesTest {
    private static final String ANSWER_FILE_NAME = "test-answer.csv";
    private static final String QUESTION_FILE_NAME = "test-question.csv";
    private QuestionLoader loader = new LoaderFromResources(QUESTION_FILE_NAME, ANSWER_FILE_NAME);
